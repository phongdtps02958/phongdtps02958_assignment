<div id="layer" style="color: #000000">
...
<table width="100%" height="581">
  <tr>
    <td colspan="3"  style="border-style:dotted; border-width:medium; border-color:#FFFFFF" valign="top" bgcolor="#66FFFF"><?php  include ("header.php"); ?>&nbsp;</td>
  </tr>
  <tr>
    <td width="20%" style="border-style:dotted; border-color:#FFFFFF" valign="top" bgcolor="FFFFFF"><?php   include ("left_panel.php");   ?>&nbsp;</td>
    <td width="60%" style="border-style:dotted; border-color:#FFFFFF" valign="top" bgcolor="FFFFFF"><?php   if($_SESSION['user_id']==null){include ("homepage.html");} else include("main.php"); 
?>&nbsp;</td>
    <td width="20%" style="border-style:dotted; border-color:#FFFFFF" valign="top" bgcolor="FFFFFF"><?php   include ("right_panel.php"); ?>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3" style="border-style:dotted; border-color:#FFFFFF" valign="top" bgcolor="66FFFF"><?php  include ("footer.php");  $temp="Bạn cần đăng nhập để mua sách!"."username: 'admin'; pass:'admin'";
